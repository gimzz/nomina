        ...
        if (!preg_match("/^[0-9]+$/", $roles)) {
          ...
          if ($result === false) {
            ...
            Swal.fire({
              icon: 'success',
              title: '¡Exito!',
              text: 'La Asignacion fue Guardado Exitosamente .',
              confirmButtonColor: '#3085d6',
              confirmButtonText: 'Aceptar'
            });
          });</script>";
...
<div class="container">
  <form action="crear_asignaciones.php" onsubmit="return funcion();"  method="POST">
  ...
  <select class="form-control" id="selector"  name="roles" >
      ...
      <input class="form-control" type="text" onkeydown="lettersOnly(this)"  id="fecha_inicio" name="fecha_inicio"><br>

      <center><label for="clave">Valor Asignacion </label></center>
      <input class="form-control" onkeydown="soloNumeros(this)"  type="text" name="fecha_final" id="fecha_final" ><br>
