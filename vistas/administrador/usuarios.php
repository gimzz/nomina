...
<div class="container">
  ...
  <br>
  <h2> Usuarios
    <a href="crear_usuarios.php" class="btn btn-primary" style="float:right;">Añadir un Usuario</a>
  </h2>
  <table class="table table-hover">
    ...
    <tbody>
    <?php
$deliverys = $persona->busqueda_usuario();
if (!empty($deliverys)) {
    foreach ($deliverys as $delivery) {
        ...
        <tr>
          ...
          <td><a href="editar_usuario.php?editId=<?php echo $delivery['id_usuario'] ?>" style="color:green"><i class="fa fa-pencil" aria-hidden="true"></i></a> 
              <a href="#" onclick="confirmar('<?php echo $delivery['id_usuario'] ?>')" style="color:red">
    ...
    function confirmar(cedula) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "usuarios.php?deleteId=" + cedula;
            }
        });
    }
</script>
